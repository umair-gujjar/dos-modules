    ...
    instance.hr_attendance.AttendanceSlider = instance.web.Widget.extend({
        ...
        start: function() {
            ...
            var tmp = function() {
                ...
                $sign_in_out_icon.toggleClass("fa-sign-in oe_attendance_sign_out_color", ! this.get("signed_in"));
                $sign_in_out_icon.toggleClass("fa-sign-out oe_attendance_sign_in_color", this.get("signed_in"));
            };
